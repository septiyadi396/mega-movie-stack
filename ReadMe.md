...
# Mega Movie Stack
is a repo for us to learn many web tech stack using themoviedb.org v3 api, the purpose is making structured api that work for all stack we made (also learning english)
...
- [Upcoming Movie List](https://developer.themoviedb.org/reference/movie-upcoming-list)
- [Movie Recommendation](https://developer.themoviedb.org/reference/movie-recommendations)
- [Movie's Details](https://developer.themoviedb.org/reference/movie-details)
